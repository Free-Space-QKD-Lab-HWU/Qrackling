...
function opt = atmosphere_file_func()
    ...
    opt.(name) = Variable( ...
        ...
        Value=OptionResult({...
            ...
            'subarctic_winter',   'US-standard', 'file'}, ...
            Labels={ ...
            'Tropical',           'Midlatitude Summer', ...
            'Midlatitude Winter', 'Subarctic Summer', ...
            'Subarctic Winter',   'U.S. Standard', 'File'}, ...
            Tags={...
...
function opt = mol_abs_param_func()
    ...
    opt.(name) = Variable(...
        ...
        Tags={...
        TagEnum.IsCondition, TagEnum.IsCondition, TagEnum.IsCondition, ...
        TagEnum.IsCondition, TagEnum.IsCondition, TagEnum.IsCondition, ...
        TagEnum.IsCondition, TagEnum.IsCondition, TagEnum.IsCondition, ...
...
function opt = source_func()
    ...
    opt.(name) = Variable(TagEnum.IsOptionResult, Parent=name, ...
        Value=OptionResult(...
            {'solar', 'thermal'}, ...
            tags={TagEnum.IsOptionResult, TagEnum.IsOptionResult}, ...
            UseLabel=true));
    %opt.(name).solar.Value = OptionResult({'solar', 'file'}, ...
    %    Tags=[TagEnum.IsCondition, TagEnum.IsFile]);
    %opt.(name).thermal.Value = OptionResult({'thermal', 'file'}, ...
    %    Tags=[TagEnum.IsCondition, TagEnum.IsFile]);
end

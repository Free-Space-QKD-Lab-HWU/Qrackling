classdef Surfaces < handle
    properties (SetAccess = protected)
        ...
        altitudes Parameters.altitude
        surface_albedo Parameters.albedo
        surface_albedo_file Parameters.albedo_file
        surface_albedo_library Parameters.albedo_library
        ambrals Parameters.bdrf_ambrals
        ambrals_file Parameters.bdrf_ambrals_file
        ambrals_hotspot_correction Parameters.bdrf_ambrals_hotspot
        cox_and_munk Parameters.bdrf_cam
        cox_and_munk_solar_wind_direction Parameters.bdrf_cam_solar_wind
        hapke Parameters.bdrf_hapke
        hapke_file Parameters.bdrf_hapke_file
        rpv Parameters.bdrf_rpv
        rpv_file Parameters.bdrf_rpv_file
        rpv_library Parameters.bdrf_rpv_library
        bpdf Parameters.bpdf_tsang_u10
    end
    methods
        ...
        function s = Altitude(s, A, options)
            ...
            s.altitudes = Parameters.altitude(A);
        end
        ...
        function s = SurfaceAlbedo(s, a)
            ...
            s.surface_albedo = Parameters.albedo(a);
        end
        ...
        function s = AlbedoFile(s, file)
            ...
            s.surface_albedo_file = Parameters.albedo_file(file);
        end
        ...
        function s = AlbedoLibrary(s, lib)
            ...
            s.surface_albedo_library = Parameters.albedo_library(lib);
        end
        ...
        function s = Ambrals(s, var, val)
            ...
            s.ambrals = Parameters.bdrf_ambrals(var, val);
        end
        ...
        function s = AmbralsFile(s, file)
            ...
            s.ambrals_file = Parameters.bdrf_ambrals_file(file);
        end
        ...
        function s = AmbralsHostspotCorrection(s, state)
            ...
            s.ambrals_hotspot_correction = Parameters.bdrf_ambrals_file(state);
        end
        ...
        function s = CoxAndMunk(s, var, val)
            ...
            s.cox_and_munk = Parameters.bdrf_cam(var, val);
        end
        ...
        function s = CoxAndMunkSolarWindDirection(s, state)
            ...
            s.cox_and_munk_solar_wind_direction = Parameters.bdrf_cam_solar_wind(state);
        end
        ...
        function s = Hapke(s, var, val)
            ...
            s.hapke = Parameters.bdrf_hapke(var, val);
        end
        ...
        function s = HapkeFile(s, file)
            ...
            s.hapke_file = Parameters.bdrf_hapke_file(file);
        end
        ...
        function s = RPV(s, var, val)
            ...
            s.rpv = Parameters.bdrf_rpv(var, val);
        end
        ...
        function s = RPVFile(s, file)
            ...
            s.rpv_file = Parameters.bdrf_rpv_file(file);
        end
        ...
        function s = RPVLibrary(s, options)
            ...
            s.rpv_library = Parameters.bdrf_rpv_library(args{:});
        end
        ...
        function s = BPDF(s, value)
            ...
            s.bpdf = Parameters.bpdf_tsang_u10(value);
        end

...
mpn = 0.5;
N = 2^12;
[wvl, intens] = gaussian_spectra(wvl_central, window, mpn, FWHM=width, points=N);
...
mpn = 0.5;
N = 2^12;
[wvl, intens] = gaussian_spectra(wvl_central, window, mpn, exponential_width=width, points=N);

...
%% line-of-sight limited as a function of altitude for an aircraft
...
yyaxis right
ylim([Altitudes(1)*3.2808399/1000,Altitudes(end)*3.2808399/1000])
ylabel('Altitude (1000\timesft)')
...
legend('Complete Jamming Range','Possible Jamming Range');
xlabel('Range (km)');
ylabel('Altitude (km)');
yyaxis right
ylim([Altitudes(1)*3.2808399/1000,Altitudes(end)*3.2808399/1000])

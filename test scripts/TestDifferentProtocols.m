...
%% decoy BB84
%declare specific components
decoyBB84_S=decoyBB84_Source(Wavelength);
decoyBB84_D=CreateDetector(Generic_Detector_Factory,Wavelength,'decoyBB84',Time_Gate_Width,Spectral_Filter_Width,Repetition_Rate);
...
COW_D=CreateDetector(Generic_Detector_Factory,Wavelength,'COW',Time_Gate_Width,Spectral_Filter_Width,Repetition_Rate);
COW_P=COW_Protocol();
%make generic components

...
%}
        function [Link_Models,Turbulence_Beam_Width] = SetTurbulenceLoss(Link_Models,Satellite,~,Geo_Spot_Size)
            ...
            Atmospheric_Turbulence_Coherence_Length = ...
                atmospheric_turbulence_coherence_length_downlink( ...
                Wavenumber,Zenith, Satellite_Altitude, ...
                ghv_defaults('Standard', Link_Models.Turbulence));
            %output variables

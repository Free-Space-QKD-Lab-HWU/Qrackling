...
%% compute the heading and elevation of a 3D vector r and choose the heading angle which minimises distance to the previous heading angle to improve plotting

classdef Satellite_Uplink_Model < Link_Model
    ...
    methods (Access=public)
        ...
        function [Link_Model,Link_Loss_dB] = Compute_Link_Loss(Link_Model,Satellite,Ground_Station)
            ...
            %output variables
            spot_tl = long_term_gaussian_beam_width(Geo_Spot_Size(Elevation_Flags), Link_Lengths(Elevation_Flags) ,...
                                        2*pi/(Ground_Station.Source.Wavelength*10^-9), Atmospheric_Turbulence_Coherence_Length);

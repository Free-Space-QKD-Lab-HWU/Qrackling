classdef decoyBB84_Protocol < Protocol
    ...
    methods
        ...
        function [Secret_Key_Rate,QBER,Photon_Rate_In,Photon_Rate_Det] = EvaluateQKDLink(Protocol,Source,Detector,Link_Loss_dB,Background_Count_Rate)
            ...
            %                                           Eff, QBER_Jit, DT, ...
            %                                           pol_err);
            [Current_SKR,Current_QBER,R_In, R_Det]=decoyBB84_model(MPN, SP, SPE, RR,...
                                                       DE, BCR_Prob(i), ...
                                                       Link_Loss_dB(i), ...
                                                       Eff, QBER_Jit, DT, ...
                                                       pol_err, ...

...
function result = QkdPassSimulation(Receiver, Transmitter, proto, options)
    ...
    if ~isempty(options.Environment)
        [link_loss, ~] = nodes.linkLoss("qkd", Receiver, Transmitter, ...
            "apt", "transmitter", "geometric", "turbulence", ...
            "atmospheric", "receiver",...
            "environment", options.Environment,...
            "N_Detectors",proto.num_detectors);
        ...
        [link_loss, ~] = nodes.linkLoss("qkd", Receiver, Transmitter, ...
            "apt", "transmitter", "geometric", "turbulence", "receiver",...
            "N_Detectors",proto.num_detectors);
    ...
    noise_sources = [ ...
        environment.Noise( ...
            ...
            ones(size(headings)) .* Receiver.Detector.Dark_Count_Rate * proto.num_detectors), ...
        environment.Noise( ...
            "Background Counts", ...

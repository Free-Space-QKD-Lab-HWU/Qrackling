        ...
        function [Background_Rates, Background_Rates_sr_nm] = GetLightPollutionCountRate(Ground_Station, Headings, Elevations)
            ...
            if ~isequal(Ground_Station.Sky_Brightness_Store_Location,'none')
                ...
                Background_Rates = Background_Rates_sr_m2_nm * ...
                    ...
                    10 * ...                                                %Ground_Station.Detector.Spectral_Filter_Width
        ...
        function [Total_Background_Count_Rate, Ground_Station, Headings, Elevations] = ...
            ...
            if ~isempty(Ground_Station.Atmosphere_File_Location)
                ...
                for Time_Index = All_Time_Indices(Simulate_Flags)
                    ...
                    Sky_Radiance(Time_Index, :) = utilities.irradiance2radiance( ...
            ...
            elseif ~isequal(Ground_Station.Sky_Brightness_Store_Location,'none')
                ...
                disp(newline)
                warning([...
                    'No valid background count rate format provided. ', ...
                    newline, ...
                    'Can provide a Sky_Brightness_Store_Location, ', ...
                    newline, ...
                    'a SMARTS_config, or an Atmosphere_File_Location. ', ...
                    newline, ...

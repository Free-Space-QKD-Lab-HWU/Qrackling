    ...
    methods
        ...
        function [success, destination] = write_file(SMARTS_input, varargin)
            ...
            if isempty(file_name)
                %first_line = strsplit(SMARTS_input.input_string, newline);
                %halves = strsplit(first_line{1}, '!');
                %file_name = strrep(halves{1}(1:end-2), ' ', '_');
        ...
        function success = run_smarts(SMARTS_input, varargin)
            ...
            target = [SMARTS_input.smarts_path, parts{end}];

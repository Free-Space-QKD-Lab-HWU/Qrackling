...
%satellite with the correct orbital parameters
    ...
    HubSatScope = components.Telescope(HubSat_Scope_Diameter,...
    ...
    HubSatSource = components.Source(Wavelength,...
        ...
        'Probability_Signal',HubSatSource_Probs(1),...
        'Probability_Decoy',HubSatSource_Probs(2),...
    ...
    BeaconTelescope = components.Telescope(BeaconTelescopeDiameter,'FOV',BeaconTelescopeFOV,'Wavelength',BeaconWavelength); %downlink beacon has 10mm diameter and 0.4 degrees cone angle
    ...
    HubSat=nodes.Satellite(HubSatScope,...
        'Name', 'SPOQC',...
        'Source',HubSatSource,...
        'Beacon',HubSatBeacon,...
        'Camera',HubSatCamera,...

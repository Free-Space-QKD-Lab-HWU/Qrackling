classdef Flat_Top_Beacon < Beacon
    ...
    methods
        function Flat_Top_Beacon = Flat_Top_Beacon(Telescope, Power,...
            ...
            Flat_Top_Beacon@Beacon(Telescope, Power,Wavelength,varargin{:});
        ...
        GeoSpotDiameter = (Flat_Top_Beacon.Limit_Half_Angle*Range);
        GeoLoss = Camera.Collecting_Area./(pi*GeoSpotDiameter.^2);
        end
    end
end
...
% probability of dark counts (Bob's detetcion stage - convolution of all detectors used by Bob)
...
%(imperfect polarisation optics, channel dechoerence, imperfect state preparation)
mu = state_prep_error;

% probability of a signal event (Bob's estimation based on Alice's original signal)
...
% [this has been extrapolated from the paper]
f = 1.366 .* qber + 1.117;

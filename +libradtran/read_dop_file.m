function [stokes_parameters, wvl] = read_dop_file(dop_data_file, options)
    arguments
    ...
    stokes_parameters.I = table2array(data(1:4:end, end));
    stokes_parameters.Q = table2array(data(2:4:end, end));
    stokes_parameters.U = table2array(data(3:4:end, end));
    stokes_parameters.V = table2array(data(4:4:end, end));
